...
With this fresh session key, Bob encrypts the message and sends it to Alice.
...
The protocol aborts prematurely if Carol could already break it before Bob has sent the message.

"Story? PoC or GTFO!" I hear our quality-conscious readers demand.
