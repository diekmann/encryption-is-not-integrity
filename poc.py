...
print(r"""One of the first things we learn in our introductory security course is that Carol could Man-in-the-Middle (MitM) the DH exchange to obtain session keys with Alice and Bob herself, while poor Alice and poor Bob still believe they are talking to each other.
...
thewire = bob_step1_lib(thewire)
print("""After RSA decryption, Bob's code happily accepts all values.""")
