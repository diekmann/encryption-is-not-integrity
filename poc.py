...
print("""We all remember this common setup from our introductory security course:
...
print("""But this article is slightly different from an introductory security course:
...
h2("Run 0: Short recap of Diffie-Hellman")


print("""Alice and Carol are just returning from their recent security course.
...
ZZ_a = pow(1, xa, p)""")
print()
print(r"""The prime $p$, the generator $g$, and the public keys are public knowledge.
...
h2("Run 2: Encrypted textbook DH using parts of the OpenSSL library")
init_global_state(p_RFC3526, g_RFC3526)
...
# Carol hax0rs it
print(r"""Carol chose a great `prime' $\mathit{pc}$ and knows the key is broken: Only one bit is set!
...
print(r"""This is what happened so far, where \texttt{RSA} corresponds to \texttt{RSA_sign} as defined above:""")
